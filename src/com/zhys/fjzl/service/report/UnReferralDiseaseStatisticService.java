 ...
 *
 */
@Service("UnReferralDiseaseStatisticService")
@Transactional(isolation = Isolation.READ_COMMITTED, readOnly = true, rollbackFor = Throwable.class)
public class UnReferralDiseaseStatisticService extends BaseService {
	...
	public JSONObject getData(PageParam mapper, User user) throws Exception {
		...
		List<Map<String, Object>> dataList = sqlDao.list("unReferralDiseaseStatistic.main", mapper);
	...
	private JSONObject toJson(List<Map<String, Object>> dataList) {
		...
		for(int i = 0; i < dataList.size(); i++) {
			...
			String diseaseName = StringUtil.null2string(map.get("his_disease_name"));
