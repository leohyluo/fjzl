...
public class DateUtils {
	 ...
	 * @throws Exception 
     */
    public static int judgmentDate(Date date) throws Exception {
	 ...
	 */
	public static String chinaDate(String dateStr) throws ParseException {
...
//		sdf.setTimeZone(TimeZone.getDefault());
	 ...
	 * @throws Exception 
	 */
	public static String getTimeOut(String currentTime, int iHour) throws Exception {
		try {
	 ...
	 * @throws Exception 
	 */
	public static String getTimeLastOut(String currentTime, int iHour) throws Exception {
		try {
			DateFormat sdf = getDateFormat(DATE_FORMAT);
			java.util.Date result = sdf.parse(currentTime);
	 ...
	 * @throws ParseException 
	 */
	public static String getCurrDateNextMinute(String currDate, int minute) throws ParseException {
		DateFormat sdf = getDateFormat(TIMEF_FORMAT);
	 ...
	 * @throws Exception 
	 */
	public static String getDateStr(String dateStr, String fmt) throws Exception {
		try {
			if (StringUtil.isEmpty(dateStr)) {
				return "";
			}
	 ...
	 * @throws Exception 
	 */
	public static java.util.Date getDate(String dateStr) throws Exception {
		try {
			if (StringUtil.isEmpty(dateStr)) {
				return null;
			}
	...
	public static java.util.Date parseDate(String dateStr, String format) throws Exception {
		try {
			if (StringUtil.isEmpty(dateStr)) {
				return null;
			}
	 ...
	 * @throws Exception 
	 */
	public static String getZhCNDateTime(String dateStr) throws Exception {
...
//		Calendar now = Calendar.getInstance(TimeZone.getDefault());
	...
	public static java.sql.Date getSqlDate(String dateTimeStr) throws ParseException {
	...
	public static Date getBeforDate(int i) throws Exception {
	...
	public static Date getAfterDate(String year, String month) throws Exception {
		String time = "";
		String hours = "235959";
		if ("12".equals(month)) {
	...
	public static String OverflowHidden(String str, int len) {
		if (StringUtil.isEmpty(str) || str.getBytes().length <= len) {
			return str;
		}
		byte b[] = new byte[len];
		for (int i = 0; i < len; i++) {
	 ...
	 * @throws ParseException 
	 */
	public static String getWeek(String dateTime, String dateFormat) throws ParseException {
	...
	public static String getLastOrNextMonth(String dataTime, String formatStr,
			int conut, String... returnFormatStr) throws ParseException {
	 ...
	 * @throws ParseException 
	 */
	public static List<String> getWeek(List<String> dateList) throws ParseException {
	 ...
	 * @throws ParseException 
	 */
	public static String getDateStr_2(String dateStr, String fmt) throws ParseException {
		if (StringUtil.isEmpty(dateStr)) {
			return "";
		}
