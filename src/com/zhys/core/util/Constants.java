...
public interface Constants {
    ...
    // 黑名单缓存KEY
    public static final String CACHE_KEY_BLACK_LIST = "com.zhys.kkmy.sms.blacklist";
    // 白名单缓存KEY
    public static final String CACHE_KEY_WHITE_LIST = "com.zhys.kkmy.sms.whitelist";
}
