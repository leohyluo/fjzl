package com.zhys.core.controller;
...
import com.zhys.core.file.FileDownLoad;
import com.zhys.core.file.FileUpLoad;
import com.zhys.core.image.ImageScale;
import com.zhys.core.image.ImageScaleImpl;
import com.zhys.core.system.SystemParameter;
import com.zhys.core.util.BeanUtil;
import com.zhys.core.util.FtpConfig;
import com.zhys.core.util.FtpUploader;
...
public class FileController extends BaseController {
    ...
    public ModelAndView upload(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        fileUpLoad.write(fileItem, key);//写入文件
        ...
        String relativePath = contextPath + path + dateDir + "/" + key + fileUpLoad.getFileExt(fileItem);//相对路径（相对服务器的路径，适用于图片上传）
        String absolutePath = getServletContext().getRealPath(path + dateDir + "/" + key + fileUpLoad.getFileExt(fileItem));//绝对路径（文件在硬盘上的绝对路径）
        Map<String, Object> model = new HashMap<String, Object>();
        model.put("result", "success");
        model.put("relativePath", relativePath);//相对路径
