...
import com.zhys.core.exception.StartupException;
import com.zhys.core.util.SpringContextHolder;
import com.zhys.sys.domain.Sysconfig;
import com.zhys.sys.service.SysconfigService;
...
public class StartupServlet extends javax.servlet.http.HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            SystemParameter.set("exportMaxRows", SystemParameter.get("exportMaxRows"));
