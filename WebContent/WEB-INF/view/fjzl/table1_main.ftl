...
<head>
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            $("#iframe").attr("src", "${path}/fjzl/table1_add.do");
        }
        ...
        function edit(event, value) {
            ...
            $("#iframe").attr("src","${path}/fjzl/table1_edit.do?id="+value);
        }
        ...
        function del(event,val) {
            ...
            $.messager.confirm("提示信息", "你确认要删除该记录吗？", function(b) {
                if (b) {
                    $.ajaxPost("${path}/fjzl/table1_delete.do",{"id":val},function(result){
                        $.messager.show({
                            title:"消息提醒",
                            msg:"记录删除成功",
                            timeout:5000,
            ...
            if(selections.length==0){
                ...
                $.messager.confirm("系统提示", "你确认要删除所选择的记录吗？", function(b){
                    if(b){
                        ...
                        $.ajaxPost("${path}/fjzl/table1_deleteBatch.do", {"ids":ids}, function(result) {
                            $.messager.show({
                                title:"消息提醒",
                                msg:"记录删除成功",
                                timeout:5000,
        ...
        function view(event,value){
            ...
            $("#iframe").attr("src","${path}/fjzl/table1_view.do?id="+value);
        }
        ...
        function refreshPage(){
            window.location="${path}/fjzl/table1_main.do";
            return false;
        }
        ...
        function searchPage(reset) {
            ...
            var table1 = $("#form").serializeJson();
            table1.refresh = "1"; //刷新记录数参数
            $("#table").datagrid("clearSelections").datagrid("load",table1);
        }
    </script>
</head>
...
<div region="center" title="当前位置：新建表管理">
    <table id="table"
           url="${path}/fjzl/table1_page.do"
           border="false"         <#--无边框-->
           fit="true"             <#--自动填充宽度高度-->
