...
<head>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#table").datagrid({
                ...
                columns:[[
                    ...
                    {title:'数据来源(导入/手动添加)',field:'source',width:150,sortable:true},
        ...
        function refreshPage(){
            window.location="${path}/fjzl/icd9_main.do";
            return false;
        }
    ...
    <form id="form" name="form" style="display: none">
        <table class="table">
            ...
            <tr>
                ...
                <td class="td"><input id="source" name="source" type="text" class="input easyui-numberbox" min="0" max="9999999999" precision="0"/></td>
            </tr>
            <tr>
                <td class="th">数据来源(导入/手动添加)</td>
                <td class="td"><input id="source_min" name="source_min" type="text" class="input easyui-numberbox" min="0" max="9999999999" precision="0"/></td>
            </tr>
            <tr>
                <td class="th">至</td>
                <td class="td"><input id="source_max" name="source_max" type="text" class="input easyui-numberbox" min="0" max="9999999999" precision="0"/></td>
            </tr>
            <tr>
                <td class="th">创建时间</td>
