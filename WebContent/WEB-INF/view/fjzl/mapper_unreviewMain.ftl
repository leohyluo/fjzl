    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#table").datagrid({
                ...
                pageNumber:1,           
                pageSize:20,            
                queryParams:{"refresh":"1","type":"${type}","drug_status_in":"0,2",reviewFlag:"0"},
                ...
                columns:[[
                    ...
                    {title:'单位',field:'unit',width:150,sortable:true,hidden:true},
                    {title:'药品等级',field:'grade',width:150,sortable:true,hidden:true},
                    {title:'药物类型',field:'type',width:150,hidden:true,sortable:true,formatter:function(value, data, index){
                    		if(value=="1"){
                    			return "西药";
                    		}
                    		if(value=="2"){
					...
					{title:'备注',field:'memo',width:250,sortable:true}
            	]],
                toolbar:[
                    {
                        handler:refreshPage,
        ...
        function review(event,value) {
            ...
            if(${type}==1)
            {
            $("#iframe").attr("src","${path}/fjzl/mapper_review.do?id="+value);
            }
            else if(${type}==2)
            {
              $("#iframe").attr("src","${path}/fjzl/mapper_zcyReview.do?id="+value);
            }
            else
            {
             $("#iframe").attr("src","${path}/fjzl/mapper_zyypReview.do?id="+value);
            }
        }
        /**
         * 查看药品对照表详细
        ...
        function refreshPage(){
            window.location="${path}/fjzl/mapper_unreviewMain.do?type=${type}";
            return false;
        }
...
<#if type==1> 
	<div region="center" title="当前位置：机构未对照西药管理">
</#if>
<#if type==2>
	<div region="center" title="当前位置：机构未对照中成药管理">
</#if>
<#if type==3>
	<div region="center" title="当前位置：机构未对照中药饮片管理">
</#if>
    <table id="table"
