...
<head>
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            $("#iframe").attr("src", "${path}/fjzl/mapper_add.do?type=2");
        }
        ...
        function refreshPage(){
            window.location="${path}/fjzl/mapper_zcymain.do";
            return false;
        }
		...
		*/
		function upload() {
            ...
            $("#iframe").attr("src","${path}/fjzl/mapper_zcyUpload.do");
		}
		function download() {
		    window.location="${path}/fjzl/template_download.do?fileType=HIS_ZCY";
			return false;
		}
    </script>
</head>
...
<div region="center" title="当前位置：药品对照表管理">
    <table id="table"
           url="${path}/fjzl/mapper_zcypage.do"
           border="false"         <#--无边框-->
           fit="true"             <#--自动填充宽度高度-->
