...
<head>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.showLoad();
            $.ajaxPost("${path}/fjzl/icd9_addSave.do", {"icd9":icd9}, function(result) {
            	if(result=="1"){
    ...
    <form id="form" name="form" style="+zoom:1;">
        <table class="table-border" width="100%">
            ...
            <tr>
                ...
                <td class="td"><input type="text" id="icd9" name="icd9" class="input easyui-validatebox" validType="maxLength[20]" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">icd9名称</td>
                <td class="td"><input type="text" id="icd9_name" name="icd9_name" class="input easyui-validatebox" validType="maxLength[50]" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">数据来源(导入/手动添加)</td>
                <td class="td"><input type="text" id="source" name="source" class="input easyui-numberbox" min="0" max="9999999999" precision="0" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">创建时间</td>
