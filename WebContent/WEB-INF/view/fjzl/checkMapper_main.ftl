...
<head>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#table").datagrid({
                ...
                columns:[[
                    ...
                    {title:'机构检查id',field:'org_check_id',width:150,sortable:true,hidden:true},
        ...
        function refreshPage(){
            window.location="${path}/fjzl/checkMapper_main.do";
            return false;
        }
        ...
        <table class="table">
           <!-- <tr>
            ...
            <tr>
                <td class="th">状态</td>
                <td class="td">
                 <select id="body_check_status" class="easyui-combobox" name="body_check_status" panelMaxHeight="200" style="width:142px;">
