    ...
    <script type="text/javascript">
        $(function() {
            ...
            function load(params) {
            	$.post('${path}/fjzl/report_getdiseaseStatisticData.do', params,function(data){
            ...
            load({'refresh':'1','referralFlag':'1','zndz_org_id':'a5907f196aa4134ac28a3f4c9ec3a957'});
        });
    </script>
</head>
