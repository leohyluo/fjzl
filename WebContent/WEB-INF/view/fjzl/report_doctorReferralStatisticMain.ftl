    ...
    <script type="text/javascript">
        $(function() {
            ...
            function load(params) {
            	$.post('${path}/fjzl/report_getdoctorReferralStatisticData.do', params,function(data){
	            	var doctorNameArr = data.doctorNameArr;
	            	if(doctorNameArr && doctorNameArr.length > 0) {
	            		$('#div_no_data').hide();
	            		$('#main').show();
	            		option.xAxis[0].data = data.doctorNameArr;
...
<div region="center" title="当前位置：医生转诊数量统计报表">
