    ...
    <script type="text/javascript">
        $(function(){
           ...
           $("#drugContrastCfda").datagrid({
                ...
                pageSize:20,       
                height:520, 
                queryParams:{"refresh":"1","cpdrug_status":"1","_enable":"1"},
                onLoadSuccess:function(data){
                ...
                columns:[[
            		{title:'药品名称',field:'cpdrugname',width:249,sortable:true},
        ...
        function contrast(status) {
            ...
            if(selections.length==0){
                ...
                $.messager.confirm("系统提示", "你确认要对照所选择的记录吗？", function(b){
                    if(b){
                        var ebmDrugId = selections[0].id_;
        ...
        function searchPage(reset) {
            ...
            drugContrastData.cpdrug_status = "1";
            ...
            <tr>
	            <td class="td">
		            <div style="margin:5px">
	            		药品名称:<input id="cpdrugname" name="cpdrugname" type="text" class="input">
	            	...
	            	<table id="drugContrastCfda"
	                    url="${path}/fjzl/mapper_zcyReviewPage2.do"
	                    border="true"         <#--无边框-->
	                    fit="false"             <#--自动填充宽度高度-->
