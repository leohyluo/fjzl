...
/**
        ...
        function save() {
            ...
            $.showLoad();
            $.ajaxPost("${path}/fjzl/disease_editSave.do", {"disease":disease}, function(result) {
            	if(result == "-1") {
    ...
    <form id="form" name="form" style="+zoom:1;">
        ...
        <table class="table-border" width="100%">
            ...
            <col width="80%">
                ...
                <td class="td"><input type="text" id="icd_10" name="icd_10" class="input easyui-validatebox" validType="maxLength[10]" value="${(disease.icd_10)!}" style="width:300px;"/></td>
            </tr>
              <tr>
                <td class="th">icd10名称</td>
                <td class="td"><input type="text" id="icd10Name" name="icd10Name" class="input easyui-validatebox" validType="maxLength[10]" value="${(disease.icd10Name)!}" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">临床诊断名称</td>
                <td class="td"><input type="text" id="disease_name" name="disease_name" class="input easyui-validatebox" validType="maxLength[50]" value="${(disease.disease_name)!}" style="width:300px;" required="true"/></td>
            </tr>   
  <tr>
        ...
        <tr>
            <td class="td">
            <input name="sa_ids" id="sa_ids" type="hidden" class="input easyui-validatebox" validType="maxLength[100]" style='width:250px;'/>
            <input name="sa_icd9Name" id="sa_icd9Name" type="text" class="input easyui-validatebox" required="true" validType="maxLength[20]" style='width:120px;'/></td>
           ...
           <!-- <select id="diseaseicd9" class="easyui-combobox" name="drug_status" panelMaxHeight="200" style="width:142px;">
            ...
            <tr>
                <td class="th">助记符</td>
                <td class="td"><input type="text" id="py_sympol" name="py_sympol" class="input easyui-validatebox" validType="maxLength[50]" value="${(disease.py_sympol)!}" style="width:300px;"/>
             ...
             <tr>
               <td class="th">对应系统</td>
                <td class="td"><input type="text" id="dis_system" name="dis_system" class="input easyui-validatebox" validType="maxLength[64]" value="${(disease.dis_system)!}" style="width:300px;"/></td>
            </tr>
              <tr>
               <td class="th">一级科室</td>
                <td class="td"><input type="text" id="dept_lv1" name="dept_lv1" class="input easyui-validatebox" validType="maxLength[64]" value="${(disease.dept_lv1)!}" style="width:300px;"/></td>
            </tr>
               <tr>
                <td class="th">二级科室</td>
                <td class="td"><input type="text" id="dept_lv2" name="dept_lv2" class="input easyui-validatebox" validType="maxLength[64]" value="${(disease.dept_lv2)!}" style="width:300px;"/></td>
            </tr>
            <tr style="display: none">
                <td class="th">所属科室</td>
                <td class="td"><input type="text" id="department" name="department" class="input easyui-validatebox" validType="maxLength[64]" value="${(disease.department)!}" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">疾病评估</td>
                <td class="td"><input type="text" id="assessment" name="assessment" class="input easyui-validatebox" validType="maxLength[500]" value="${(disease.assessment)!}" style="width:300px;"/></td>
            </tr>
            <tr>
                <td class="th">疾病等级</td>
                <td class="td"><input type="text" id="grade" name="grade" class="input easyui-numberbox" min="0" max="9999999999" precision="0" value="${(disease.grade)!}" style="width:300px;"/></td>
            </tr>
            <!-- <tr style="display: none">
                <td class="th">审核状态</td>
