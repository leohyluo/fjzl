    ...
    <script type="text/javascript">
        $(function() {
            ...
            function load(params) {
            	$.post('${path}/fjzl/report_getUnreferralDiseaseMainData.do', params,function(data){
            ...
            load({'refresh':'1','examResult':'0','referralFlag':'0','zndz_org_id':'a5907f196aa4134ac28a3f4c9ec3a957'});
        });
    </script>
</head>
...
<div region="west" split="true" border="true" title="操作面板" style="width:250px;padding:10px;">
    <form id="form" name="form" style="display: none">
    	...
    	<input type="hidden" name="referralFlag" value="0">
    	<input type="hidden" name="zndz_org_id" value="a5907f196aa4134ac28a3f4c9ec3a957">
        <#include "/WEB-INF/view/fjzl/report_search_bar.ftl"/>
    </form>
</div>
<div region="center" title="当前位置：建议转诊而未转诊的疾病统计报表">
