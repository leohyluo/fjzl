    ...
    <script type="text/javascript">
        $(function(){
           ...
           $("#drugContrastCfda").datagrid({
                ...
                pageSize:20,       
                height:520, 
                queryParams:{"refresh":"1","chdrug_status":"1","_enable":"1"},
                onLoadSuccess:function(data){
                ...
                columns:[[
                    {title:'药品名称',field:'name_',width:249,sortable:true},
        ...
        function searchPage(reset) {
            ...
            drugContrastData.chdrug_status = "1";
            ...
            <tr>
	            <td class="td">
		            <div style="margin:5px">
	            		药品名称:<input id="name_" name="name_" type="text" class="input">
	            	...
	            	<table id="drugContrastCfda"
	                    url="${path}/fjzl/mapper_zyypReviewPage2.do"
	                    border="true"         <#--无边框-->
	                    fit="false"             <#--自动填充宽度高度-->
