    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#table").datagrid({
                ...
                pageNumber:1,           
                pageSize:20,            
                queryParams:{"refresh":"1","disease_status_in":"1,3,4,5"},
                ...
                columns:[[
                    ...
                    {title:'知识库疾病名称',field:'diseaseName',width:150,sortable:true},
                    {title:'知识库疾病ICD10',field:'ebmIcd10',width:150,sortable:true},
                    ...
                    {title:'疾病等级',field:'grade',width:150,sortable:true},
        ...
        function refreshPage(){
            window.location="${path}/fjzl/diseaseMapper_reviewMain.do";
            return false;
        }
        ...
        function searchPage(reset) {
            ...
            mapper.disease_status_in="1,3,4,5";
...
<div region="center" title="当前位置：疾病对照表管理">
    <table id="table"
