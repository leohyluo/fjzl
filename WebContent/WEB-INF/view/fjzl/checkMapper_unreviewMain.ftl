    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#table").datagrid({
                ...
                pageNumber:1,           
                pageSize:20,            
                queryParams:{"refresh":"1","body_check_status_in":"0,2"},
                ...
                frozenColumns:[[
                    {field:'ck',checkbox:true},
                     {title:'操作',field:'id',width:140,sortable:false,align:"center",
                ...
                columns:[[
                    ...
                    {title:'检查等级',field:'grade',width:150,sortable:true,hidden:true},
        ...
        function review(event,value) {
            ...
            $("#iframe").attr("src","${path}/fjzl/checkMapper_review.do?id="+value);
        }
        ...
        function refreshPage(){
            window.location="${path}/fjzl/checkMapper_unreviewMain.do";
            return false;
        }
        ...
        function searchPage(reset) {
            ...
            checkMapper.body_check_status_in="0,2";
...
<div region="center" title="当前位置：未对照检查管理">
    <table id="table"
