...
<head>
        ...
        $(function() {
            ...
            $("#table").datagrid({
                ...
                columns:[[
                    ...
                    {title:'状态，已对照/未对照/对照失败',field:'drug_status',width:150,sortable:true,formatter:function(value, data, index){
                    		if(value=="0"){
                    			return "未对照";
                    		}
                    		if(value=="1"){
 ...
 /**
        ...
        function add() {
            ...
            $("#iframe").attr("src", "${path}/fjzl/mapper_add.do?type=3");
        }
        ...
        function refreshPage(){
            window.location="${path}/fjzl/mapper_zyypmain.do";
            return false;
        }
		...
		*/
		function upload() {
            ...
            $("#iframe").attr("src","${path}/fjzl/mapper_zyypUpload.do");
		}
		function download() {
		    window.location="${path}/fjzl/template_download.do?fileType=HIS_ZYYP";
			return false;
		}
    </script>
</head>
...
<div region="center" title="当前位置：药品对照表管理">
    <table id="table"
           url="${path}/fjzl/mapper_zyyppage.do"
           border="false"         <#--无边框-->
           fit="true"             <#--自动填充宽度高度-->
