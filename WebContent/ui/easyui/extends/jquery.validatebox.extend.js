/*******************************************
 * Title: 针对 jquery.validatebox.js 的扩展
...
$.extend($.fn.validatebox.defaults.rules, {
	maxLength:{
        validator: function(value, param){
            // return value.replace(/[^\x00-\xff]/gi, "---").length <= param;
    ...
    length: {
    	validator: function(value, param){
    		// var content = value.replace(/[^\x00-\xff]/gi, "---");
    		var content = value;
            return content.length >= param[0] && content.length <= param[1];
        },
